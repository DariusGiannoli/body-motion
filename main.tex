...
($n=14$). Command variation is shown for the recorded pipelines and
...
(Holm-adjusted $p=0.049$) while xcess horizontal
...
\emph{Delivered-command behavior.} Body motion produced significantly smoother commands than the transmitter. Delivered-command variation decreased by 88.8\%, representing a mean reduction of 3010 ($p<0.001$).
