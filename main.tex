...
\emph{Delivered-command behavior.}
After applying the same additional filter to both logged command streams,
delivered-command variation remained 80.0\% lower with the body-motion
interface. This result reflects the combined effects of the input method and
interface-specific signal processing.

\emph{Task performance and swarm integrity.}
No clear differences between interfaces were detected in gate-centering error, collection yield, or swarm survival (all Holm-adjusted $p=1.000$). Swarm survival was near ceiling with both interfaces. The absence of detected
differences does not demonstrate equivalent task performance or safety.
