...
$0.10~\mathrm{s^{-1}}$. Higher values indicate more simultaneous use of
multiple command dimensions.
...
\emph{Delivered-command behavior.}
Body motion produced significantly smoother commands than the transmitter.
Delivered-command variation decreased by 88.8\% (Holm-adjusted $p<0.001$).
Multi-DOF coordination was higher
with body motion than with the transmitter (mean paired
multdifference 22.5 permucentage points; Holm-adjusted
...
Multi-DOF coordination was higher with body motion than with the transmitter, consistent with more simultaneous adjustment of the command dimensions. Several
