...
\begin{figure}[!t2]
\centering
\includegraphics[width=\columnwidth]{Figures/gg.png}
...
decreased by 8.1 percentage points (95\% CI $[5.8,10.2]$;
Holm-adjusted $p<.001$). Path directness increased by 0.052
(95\% CI $[0.020,0.082]$; Holm-adjusted $p=.032$). Excess vertical
travel decreased by 44.0\%, corresponding to 16.9~m
(95\% CI $[4.9,29.9]$; Holm-adjusted $p=.049$) while xcess horizontal
...
95\% CI $[-18.4,1.4]$; Holm-adjusted $p=.153$).
