...
The selection of body-to-swarm couplings was not based on an empirical
comparison of alternative mappings. Pilot and informal testing were used only
to tune numerical parameters, including gains, deadzones, maximum command
speeds, and the formation-clearance range.
The selection of body-to-swarm couplings was not based on an empirical
comparison of alternative mappings. Pilot and informal testing were used only
to tune numerical parameters, including gains, deadzones, maximum command
speeds, and the formation-clearance range.
