...
participant, yielding 14 paired observations. Interfaces were compared using exact two-sided Wilcoxon signed-rank tests ($\alpha=.05$)~\cite{wilcoxon1945ranking}, with Holm adjustment within outcome families~\cite{holm1979procedure}.
...
\emph{Traversal efficiency.} Body motion significantly improved all traversal metrics compared to the transmitter. Completion time decreased by 19.4\%, representing a mean reduction of 22.4~s (Holm-adjusted $p=.001$) with 13 of the 14 participants going faster using body motion. Centroid path length was 7.0\% shorter (Holm-adjusted $p=.011$), and mean speed was 12.5\% higher (Holm-adjusted $p=.001$).
...
(Holm-adjusted $p=.032$). Excess vertical
travel decreased by 44.0\%, corresponding to 16.9~m
(Holm-adjusted $p=.049$) while xcess horizontal
...
\emph{Delivered-command behavior.} Body motion produced significantly smoother commands than the transmitter. Delivered-command variation decreased by 88.8\%, representing a mean reduction of 3010 ($p<.001$).
