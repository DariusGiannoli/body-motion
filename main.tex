...
transmitter, an increase of 0.052 (95\% CI $[0.021,0.082]$;
...
(95\% CI $[4.9,30.1]$; Holm-adjusted $p=.025$;
...
lower These related measures indicate that the advantage arose through more
...
clear physical cost, despite no detected difference in total TLX or SUS. Participant feedback corroborated this increase in phyiscal demand as 4 particpants mentionned Arm support or smaller-excursion gains may reduce effort just like in this paper\cite{rognon2018flyjacket}. Addtionally, it was mentionned that it was easier to know how much to spread usign body motion but that some feedback could improve
spatial awareness, as in like \cite{tsykunov2019swarmtouch}.
