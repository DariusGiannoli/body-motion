...
\end{equation}
Lower values indicate less variation in the delivered commands. Active control time comprised intervals in which at least one command exceeded
this threshold. Because the tested interfaces applied different online filters, this measure captures the behavior of the entire interface rather than the input hardware alone.
...
($n=14$). Delivered-command variation and multi-DOF coordination are shown for the
recorded pipelines.
...
\emph{Trajectory characteristics.}
Body motion produced more direct trajectories than the
...
with body motion than with the transmitter (mean paired difference 22.5 percentage points; Holm-adjusted
...
explain this pattern. First, multi-DOF coordination was higher with body motion
...
body motion reduced delivered-command variation, which may help sustain forward
